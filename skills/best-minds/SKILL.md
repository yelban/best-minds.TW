...
5. **收斂綜合** — 結尾必須收斂：共識、關鍵分歧、以及對使用者問題的綜合建議。收斂不等於調和——分歧無法調和時，明說在什麼前提下該聽誰的。圓桌是手段，建議才是交付物。**歸屬要誠實**：綜合者自己延伸的具體建議（工具選型、數字門檻、操作步驟）須標明為綜合者所加，不得掛在人物名下——那是比捏造名言更輕、但同族的捏造歸屬
