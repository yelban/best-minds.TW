...
2. **Cross-examination round** — only now let each voice attack the others' specific claims. Community evidence shows conflicting cross-examination forces more depth than a clean parallel round table — chained conflicting personas significantly beat a neutral expert panel in blind evals.
3. **Blind-spot round (optional, borrowing Co-STORM Moderator)** — before converging, ask one thing: what did this whole group never touch? This voice speaks for no one, specializing in the collective blind spot.
